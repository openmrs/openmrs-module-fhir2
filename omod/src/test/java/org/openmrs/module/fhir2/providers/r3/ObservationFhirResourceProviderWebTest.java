...
public class ObservationFhirResourceProviderWebTest extends BaseFhirR3ResourceProviderWebTest<ObservationFhirResourceProvider, Observation> {
	...
	public void shouldGetObservationsByValueConceptId() throws Exception {
		...
		verify(observationService).searchForObservations(isNull(), isNull(), isNull(), isNull(), valueCodeCaptor.capture(),
		    isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull());
	...
	public void shouldGetObservationsByValueDate() throws Exception {
		...
		verify(observationService).searchForObservations(isNull(), isNull(), isNull(), isNull(), isNull(),
		    valueDateCaptor.capture(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull(),
		    isNull(), isNull());
