...
public class MedicationRequestFhirResourceProviderWebTest extends BaseFhirR4ResourceProviderWebTest<MedicationRequestFhirResourceProvider, MedicationRequest> {
	...
	public void updateMedicationRequest_shouldUpdateExistingMedicationRequest() throws Exception {
		...
		when(fhirMedicationRequestService.update(anyString(), any(MedicationRequest.class))).thenReturn(medicationRequest);
	...
	public void updateMedicationRequest_shouldThrowErrorForNonExistentMedicationRequest() throws Exception {
		...
		when(fhirMedicationRequestService.update(anyString(), any(MedicationRequest.class))).thenThrow(
