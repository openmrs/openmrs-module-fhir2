...
/**
 * Default handler for the FHIR {@link Location} resource, mapping onto the OpenMRS {@code Location}
 * table. Single backing today — claims every incoming Location. Carries the CRUD wiring lifted from
 * the original {@code FhirLocationServiceImpl}.
 */
@Component
@Order(Ordered.LOWEST_PRECEDENCE)
public class LocationBackedLocationHandler extends BaseFhirResourceHandler<Location, org.openmrs.Location> implements FhirResourceHandler<Location> {
	
	private static final String IMPLICIT_PROFILE = OPENMRS_FHIR_STRUCTURE_DEFINITION_PREFIX + "/openmrs-location";
	...
	@Override
	public boolean canHandle(@Nonnull Location resource) {
		return true;
	}
