...
public class CustomizableMetadataTranslatorImpl<A extends Attribute, T extends BaseCustomizableMetadata<A>> extends BaseProvenanceHandlingTranslator
		implements CustomizableMetadataTranslator<A, T> {
