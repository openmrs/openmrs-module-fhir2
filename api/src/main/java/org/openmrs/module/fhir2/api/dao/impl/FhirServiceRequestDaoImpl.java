...
public class FhirServiceRequestDaoImpl extends BaseFhirDao<TestOrder> implements FhirServiceRequestDao<TestOrder> {
		...
		theParams.getParameters().forEach(entry -> {
			switch (entry.getKey()) {
				...
				case FhirConstants.DATE_RANGE_SEARCH_HANDLER:
					entry.getValue()
							.forEach(dateRangeParam -> handleDateRange("scheduledDate", "dateActivated", "dateStopped",
									"autoExpireDate", (DateRangeParam) dateRangeParam.getParam())
	...
	private Optional<Criterion> handleDateRange(String scheduledDate, String dateActivated, String dateStopped,
