...
public interface LocationReferenceTranslator extends OpenmrsFhirTranslator<Location, Reference> {
	 ...
	 */
	@Override
	Reference toFhirResource(Location location);
	
	/**
	 * Maps a FHIR reference to an {@link Location}
	 *
	 * @param location the FHIR reference to translate
	 * @return the corresponding OpenMRS location
	 */
	@Override
	Location toOpenmrsType(Reference location);
}
