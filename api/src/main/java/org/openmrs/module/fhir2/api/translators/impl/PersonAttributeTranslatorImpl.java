...
public class PersonAttributeTranslatorImpl implements PersonAttributeTranslator {
	...
	private void handleLocationFormat(Extension extension, String locationId) {
		...
		Reference locationReference = new Reference().setType(LOCATION_TYPE).setReference(LOCATION_TYPE + "/" + locationId);
		...
		try {
			if (extensionValue instanceof BooleanType) {
				...
				throw new UnsupportedOperationException(
				        "Unsupported extension value type: " + extensionValue.getClass().getSimpleName());
			}
		}
		catch (Exception e) {
