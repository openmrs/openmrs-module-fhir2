...
public class DiagnosisTranslatorImpl implements DiagnosisTranslator {
    ...
    public Diagnosis toOpenmrsType(@Nonnull Diagnosis existingDiagnosis,
        ...
        if (condition.hasCode()) {
            ...
            nonCodedExtension.ifPresent(ext ->
                    diagnosisCodedOrText.setNonCoded(String.valueOf(ext.getValue())));
        ...
        Optional<Extension> rankExtension = Optional
                .ofNullable(condition.getExtensionByUrl(DIAGNOSIS_RANK_EXTENSION));
