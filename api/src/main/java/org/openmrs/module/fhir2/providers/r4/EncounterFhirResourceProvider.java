...
public class EncounterFhirResourceProvider implements IResourceProvider {
	...
	public IBundleProvider getEncountersWithMedicationRequestsSearch(
		...
		// all this convoluted testing is a null/empty check (so "location={empty_string}" is ignored)
        ...
        // all this convoluted testing is a null/empty check (so "type={empty_string}" is ignored)
