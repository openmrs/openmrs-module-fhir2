...
/**
 * Tests the CRUD/search wiring and dispatch predicates of the default Patient handler.
 * Orchestrator-level concerns (fan-out, the typed {@code searchForPatients} entry points and the
 * {@code $everything} operations) live in {@code FhirPatientServiceImplTest}.
 */
@RunWith(MockitoJUnitRunner.class)
public class PatientBackedPatientHandlerTest {
	...
	private PatientBackedPatientHandler handler;
	...
	@Before
	public void setUp() {
		handler = new PatientBackedPatientHandler() {
		...
		handler.setDao(dao);
		handler.setTranslator(patientTranslator);
	...
	@Test
	public void shouldExposePatientImplicitProfile() {
		assertThat(handler.getImplicitProfile(), equalTo("http://fhir.openmrs.org/StructureDefinition/openmrs-patient"));
	}
	
	@Test
	public void canHandle_shouldAlwaysReturnTrue() {
		assertTrue(handler.canHandle(new org.hl7.fhir.r4.model.Patient()));
	}
	...
	public void get_shouldRetrievePatientByUuid() {
		...
		org.hl7.fhir.r4.model.Patient result = handler.get(PATIENT_UUID);
	...
	@Test
	public void search_shouldSearchForPatientsByName() {
	...
	@Test
	public void search_shouldSearchForPatientsByGivenName() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
		StringAndListParam stringAndListParam = new StringAndListParam().addAnd(new StringParam(PATIENT_GIVEN_NAME));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER,
	...
	@Test
	public void search_shouldSearchForPatientsByFamilyName() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientsForPartialMatchOnGivenName() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientsForPartialMatchOnFamilyName() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientNameNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam()
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientGivenNameNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam()
		        .addAnd(new StringParam(PATIENT_GIVEN_NAME_NOT_MATCHED));
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientFamilyNameNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam()
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientGenderMatched() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientGenderNotMatched() {
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientBirthDateMatched() throws ParseException {
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientBirthDateNotMatched() {
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientDeathDateMatched() throws ParseException {
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientDeathDateNotMatched() {
		DateRangeParam dateRangeParam = new DateRangeParam().setLowerBound(UNKNOWN_DATE).setUpperBound(UNKNOWN_DATE);
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER,
		    dateRangeParam);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientCityMatched() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientCityNotMatched() {
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientStateMatched() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientStateNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam().addAnd(new StringParam(UNKNOWN_ADDRESS));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER, "state",
		    stringAndListParam);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientPostalCodeMatched() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientPostalCodeNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam().addAnd(new StringParam(UNKNOWN_ADDRESS));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER, "postalCode",
		    stringAndListParam);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenPatientCountryMatched() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
	...
	@Test
	public void search_shouldReturnEmptyCollectionWhenPatientCountryNotMatched() {
		StringAndListParam stringAndListParam = new StringAndListParam().addAnd(new StringParam(UNKNOWN_ADDRESS));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER,
		    stringAndListParam);
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenUUIDMatched() {
	...
	@Test
	public void search_shouldReturnCollectionOfPatientWhenLastUpdatedMatched() {
	...
	@Test
	public void search_shouldSearchForPatientsByOpenmrsQuery() {
		List<Patient> patients = new ArrayList<>();
		patients.add(patient);
		StringAndListParam stringAndListParam = new StringAndListParam().addAnd(new StringParam(PATIENT_GIVEN_NAME));
