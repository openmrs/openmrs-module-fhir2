...
public class FhirPractitionerServiceImplTest {
	...
	public void shouldSearchForPractitionersByNameWhoIsProvider() {
		...
		when(userService.searchForUsers(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
				.thenReturn(new SimpleBundleProvider());

		IBundleProvider results = practitionerService.searchForPractitioners(name, null, null, null, null, null, null,
				null, null, null);
	...
	public void shouldSearchForPractitionersByNameWhoIsUser() {
		StringAndListParam name = new StringAndListParam()
				.addAnd(new StringOrListParam().add(new StringParam(USER_NAME)));
		SearchParameterMap theParams = new SearchParameterMap()
				.addParameter(FhirConstants.PRACTITIONER_NAME_SEARCH_HANDLER, name);
		...
		when(userService.searchForUsers(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
				.thenReturn(new SimpleBundleProvider(practitioner2));
	...
	@Test
	public void shouldSearchForPractitionersByGivenNameWhoIsProvider() {
		...
		when(userService.searchForUsers(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
				.thenReturn(new SimpleBundleProvider());
		IBundleProvider results = practitionerService.searchForPractitioners(null, null, givenName, null, null, null,
				null, null, null, null);
	...
	@Test
	public void shouldSearchForPractitionersByGivenNameWhoIsUser() {
		StringAndListParam givenName = new StringAndListParam().addAnd(new StringParam(PRACTITIONER_GIVEN_NAME));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER,
				FhirConstants.GIVEN_PROPERTY, givenName);
	...
	public void shouldSearchForPractitionersByFamilyNameWhoIsProvider() {
		...
		when(userService.searchForUsers(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
				.thenReturn(new SimpleBundleProvider());
		IBundleProvider results = practitionerService.searchForPractitioners(null, null, null, familyName, null, null,
				null, null, null, null);
	...
	public void shouldSearchForPractitionersByIdentifierWhoIsProvider() {
		...
		IBundleProvider results = practitionerService.searchForPractitioners(null, identifier, null, null, null, null,
				null, null, null, null);
		List<IBaseResource> resultList = get(results);
	...
	@Test
	public void shouldSearchForPractitionersByIdentifierWhoIsUserAndProvider() {
		TokenAndListParam identifier = new TokenAndListParam().addAnd(new TokenOrListParam().add(IDENTIFIER));
		SearchParameterMap theParams = new SearchParameterMap().addParameter(FhirConstants.IDENTIFIER_SEARCH_HANDLER,
				identifier);
	...
	public void shouldSearchForPractitionersByAddressCity() {
		...
		when(userService.searchForUsers(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
				.thenReturn(new SimpleBundleProvider());
		IBundleProvider results = practitionerService.searchForPractitioners(null, null, null, null, city, null, null,
				null, null, null);
	...
	public void shouldSearchForPractitionersByAddressPostalCode() {
		...
		IBundleProvider results = practitionerService.searchForPractitioners(null, null, null, null, null, null,
	...
	public void shouldSearchForPractitionersByLastUpdated() {
		DateRangeParam lastUpdated = new DateRangeParam().setUpperBound(LAST_UPDATED_DATE)
