...
public class FhirPersonServiceImplTest {
	...
	public void searchForPeople_shouldReturnCollectionOfPersonForGivenNameMatched() {
		...
		when(dao.getSearchResultIds(any())).thenReturn(Collections.singletonList(PERSON_ID));
	...
	public void searchForPeople_shouldAddRelatedResourcesWhenIncluded() {
		...
		IBundleProvider results = personService.searchForPeople(null, null, null, null, null, null, null, null, null, null,
		    includes);
