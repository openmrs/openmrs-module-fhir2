...
public class ObservationFhirResourceProviderTest extends BaseFhirR3ProvenanceResourceTest<org.hl7.fhir.r4.model.Observation> {
	...
	public void searchObservations_shouldReturnMatchingObservationsWhenBasedOnParamIsSpecified() {
		...
		IBundleProvider results = resourceProvider.searchObservations(null, null, basedOnParam, null, null, null, null, null,
		    null, null, null, null, null, null, null, null, null);

		List<IBaseResource> resultList = get(results, 0, 0);
