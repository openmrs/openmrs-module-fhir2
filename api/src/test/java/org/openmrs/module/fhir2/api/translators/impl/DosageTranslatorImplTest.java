...
public class DosageTranslatorImplTest {
	...
	public void toFhirResource_shouldTranslateDrugOrderDoseToDoseQuantity() {
		...
		CodeableConcept mgFhir = new CodeableConcept();
		mgFhir.addCoding(new Coding(null, uuid, "mg"));
		when(conceptTranslator.toFhirResource(mg)).thenReturn(mgFhir);
	...
	public void toFhirResource_shouldTranslateDrugOrderDoseToDoseQuantityPreferringRxNormIfPresent() {
		...
		CodeableConcept mgFhir = new CodeableConcept();
		mgFhir.addCoding(new Coding(null, uuid, "mg"));
		mgFhir.addCoding(new Coding(FhirConstants.SNOMED_SYSTEM_URI, "snomed-ct-mg-code", "mg"));
		mgFhir.addCoding(new Coding(FhirConstants.RX_NORM_SYSTEM_URI, "rx-norm-mg-code", "mg"));
		when(conceptTranslator.toFhirResource(mg)).thenReturn(mgFhir);
