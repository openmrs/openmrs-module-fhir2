...
public class FlagFhirResourceProviderTest {
	...
	org.hl7.fhir.r4.model.Flag flag;
	...
	public void setup() {
		...
		flag = new org.hl7.fhir.r4.model.Flag();
	...
	public void shouldCreateNewFlag() {
		...
		MethodOutcome result = resourceProvider.createFlag(Flag30_40.convertFlag(flag));
	...
	public void shouldUpdateExistingFlag() {
		...
		MethodOutcome result = resourceProvider.updateFlag(new IdType().setValue(FLAG_UUID), Flag30_40.convertFlag(flag));
	...
	public void updateFlagShouldThrowInvalidRequestForUuidMismatch() {
		...
		resourceProvider.updateFlag(new IdType().setValue(BAD_FLAG_UUID), Flag30_40.convertFlag(flag));
	}
	...
	public void ShouldThrowInvalidRequestForMissingIdInFlagToUpdate() {
		...
		resourceProvider.updateFlag(new IdType().setValue(FLAG_UUID), Flag30_40.convertFlag(noIdFlag));
	}
	...
	public void shouldThrowMethodNotAllowedIfFlagToUpdateDoesNotExist() {
		...
		resourceProvider.updateFlag(new IdType().setValue(BAD_FLAG_UUID), Flag30_40.convertFlag(wrongFlag));
	}
